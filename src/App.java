...
class CarRentalSystem {
    ...
    public void returnCar(Car car) {
        ...
        for (Rental rental : rentals) {
            if (rental.getCar() == car && !rental.isReturned()) {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                if (carToReturn != null) {
                    ...
                    for (Rental rental : rentals) {
                        if (rental.getCar() == carToReturn && !rental.isReturned()) {
...
public class App {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("1", "Suzuki", "Breeza", 100.0);
        Car car2 = new Car("2", "Honda", "City", 150.0);
        Car car3 = new Car("3", "Mahindra", "3XO", 80.0);
